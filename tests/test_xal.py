...
from pythonxbox.authentication.xal import XALManager
from tests.common import get_response_json


@pytest.mark.asyncio
async def test_get_title_endpoints(respx_mock: MockRouter, xal_mgr: XALManager) -> None:
...
@pytest.mark.asyncio
async def test_get_device_token(respx_mock: MockRouter, xal_mgr: XALManager) -> None:
...
@pytest.mark.asyncio
async def test_sisu_authentication(respx_mock: MockRouter, xal_mgr: XALManager) -> None:
...
@pytest.mark.asyncio
async def test_sisu_authorization(respx_mock: MockRouter, xal_mgr: XALManager) -> None:
...
async def test_exchange_code_for_token(
    respx_mock: MockRouter, xal_mgr: XALManager
) -> None:
